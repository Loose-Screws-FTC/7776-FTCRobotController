...
public class FrontAutoSteps extends AutoSteps {
    ...
    public static double LaunchRPM = 1452.5;
    public static double AngleShift = -3.5;
...
//            .splineToLinearHeading(MapPose(new Pose2d(10, 18, Math.toRadians(-45))), 0)
            .splineToLinearHeading(MapPose(new Pose2d(52, 18, Math.toRadians(-20))), 0)
...
//            .stopAndAdd(IntakeBallsStep4.get())
            ...
            .splineToLinearHeading(MapPose(new Pose2d(52, 18, Math.toRadians(50 + AngleShift))), Math.toRadians(ShouldFlip ? -90 : 90))
            .stopAndAdd(Robot.ShootAllBallsAction())
