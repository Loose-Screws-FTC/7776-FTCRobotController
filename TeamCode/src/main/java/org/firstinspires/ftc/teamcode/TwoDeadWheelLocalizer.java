...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 9369.676488893625; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -10856.187487231284-125; // x position of the perpendicular encoder (in tick units)
    }
